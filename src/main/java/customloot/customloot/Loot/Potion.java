...
public class Potion extends GeneralItem {
    ...
    public Potion(String _name, int _rarity, int _value, ArrayList<String> _lores, Material _itemType, String _identifier, int _health, int _minLvl, int _xpBonus, int _lootBonus, int _attackBonus, int _lifesteal) {
